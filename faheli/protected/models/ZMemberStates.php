...
/**
 * This is the model class for table "z_member_states".
 *
 * The followings are the available columns in table 'z_member_states':
 * @property integer $id
 ...
 */
class ZMemberStates extends CActiveRecord
{
	/**
	...
	public function relations()
	{
		...
		return [
			'members' => [self::HAS_MANY, 'Members', 'state_id'],
    ];
	}
	 ...
	 * @return ZMemberStates the static model class
	 */
