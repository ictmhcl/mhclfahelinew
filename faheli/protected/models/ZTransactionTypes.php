...
/**
 * This is the model class for table "z_transaction_types".
 *
 * The followings are the available columns in table 'z_transaction_types':
 * @property integer $id
 ...
 */
class ZTransactionTypes extends CActiveRecord
{
	/**
	...
	public function relations()
	{
		...
		return [
			'memberTransactions' => [self::HAS_MANY, 'MemberTransactions', 'transaction_type_id'],
    ];
	}
	 ...
	 * @return ZTransactionTypes the static model class
	 */
