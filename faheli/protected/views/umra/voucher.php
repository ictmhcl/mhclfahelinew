...
<div
  ...
  <div
    style="float: left; direction: rtl"><?php echo Helpers::umraRefundVoucherNumber($transaction) ?></div>
  &nbsp;&nbsp;&nbsp;
  ...
  ?>
  <hr>
  <table style="font-family: FarumaWeb,Faruma,Arial; font-size: 14px">
    <tr>
      <td style="width: 1.5in; text-align: right">
        <span
          style="font-family: Arial;width:100%; border-bottom: 1px dotted
          grey"><?php echo $model->getUMRA_PILGRIM_ID() ?></span>
      </td>
      ...
      <td style="width: 2.5in; text-align: right; direction: rtl">
        <span
          style="width:100%; border-bottom: 1px dotted grey"><?=
            $model->person->full_name_dhivehi . '<span
            style="font-family:Arial"> (' . $model->person->id_no
            . ')</span>' ?></span>
      </td>
    ...
    <tr>
      <td style="width: 5in; text-align: right" colspan="3">
        <span
          style="font-family: Arial;width:100%; border-bottom: 1px dotted
          grey"><?= $model->person->getPermAddressText() ?></span>
      </td>
  ...
  <table style="font-family: FarumaWeb,Faruma; font-size: 14px">
    ...
    <tr>
      <td
        style="width: in; direction: rtl;text-align: right; background: #ddd;">
        <span
          style="width:100%; ; direction: rtl"><?php echo '<span style="font-family:Arial;">' . Helpers::currency(abs($transaction->amount)) . '</span>' ?></span>
    ...
    <tr>
      <td
        style="width: 5in; direction: rtl;text-align: right; background: #ddd;">
                <span
                  style="width:100%; ; direction: rtl"><?php echo '(' . CurrencyText::parse(abs($transaction->amount), 'dv') . ')' ?>
                </span>
      </td>
  ...
  <table style="font-family: FarumaWeb,Faruma; height: 0.5in; font-size: 14px">
    <tr style="color:#333">
      ...
      <td style="width: 1.5in; text-align: right; direction: rtl">ފައިސާ ދޫކުރި
        ފަރާތ:
      </td>
    </tr>
  </table>
  ...
  <table style="font-family: FarumaWeb,Faruma; height: 0.8in; font-size: 14px">
    <tr style="color:#000">
      ...
      <td style="width: 1in; text-align: left; direction: rtl">އައިޑީ ނަންބަރ:
      </td>
