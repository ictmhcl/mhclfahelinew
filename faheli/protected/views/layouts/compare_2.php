...
function actionFilter($matured = null, $maturityValue = null, $age = null,
                      $gender = null, //
...
//Insert Filter values
    ...
    $worksheet->setCellValue('H7', (($gender == 0) ? 'All' : ($age == 1 ? 'Male' : 'Female')));
    $worksheet->setCellValue('H8', (($prevHajj == 0) ? 'All' : ($age == 1 ? 'Yes' : 'No')));
    $worksheet->setCellValue('H9', (($badhalHajj == 0) ? 'All' : ($age == 1 ? 'Yes' : 'No')));
...
// Wrap the file and send
    $objWriter = PHPExcel_IOFactory::createWriter($xlFile, 'Excel2007');
