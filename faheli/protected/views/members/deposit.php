...
<h3><span style="color:green">Deposit Collection </span>: <?php echo ucwords($model->person->full_name_english); ?> <small><strong><?php echo $model->MHC_ID ?></strong></small></h3>
    ...
    <div class="panel panel-success" style="margin-bottom:10px">
      ...
      <div class="panel-body">
        ...
        <div class="col-md-4 col-md-offset-1">
          ...
          <div class="form-group row">
            <?php echo CHtml::label('Deposit Collected', 'depositCollected', ['class' => 'control-label col-md-6', 'style' => 'margin-top:5px']); ?>
            <div class="col-md-6">
              <?php
              echo CHtml::checkBox('depositCollected', false, [
              ]);
              ?>
            </div>
          </div>
          <div class="pull-right">
            ...
            <button type="submit" class="btn btn-sm btn-primary btn-default"
                    onClick='js:
                                if ($("#depositCollected").is(":checked") == false) {
                          alert("You must confirm that you have collected the payment by marking the check box labelled \"Deposit Collected\"");
                          turnBlockOn = false;
                          return false;
                        } else {
              ...
              <icon class="glyphicon glyphicon-circle-arrow-down"></icon> Confirm & Print Receipt</button>
          </div>
